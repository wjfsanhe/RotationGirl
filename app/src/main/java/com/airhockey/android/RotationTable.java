...
public class RotationTable extends Activity implements RotationUpdateDelegate{
    ...
    public void onRotationUpdate(float[] newMatrix, float[] newQuat) {
        ...
        //Quaternion curQuat = new Quaternion(newQuat[1], newQuat[3],-newQuat[2], newQuat[0]);
        ...
        //we need rotate machine rotate anti-clockwise 90 degree across Z axis ,
        //and anti-clock 90 degree across x axis.
        curQuat = curQuat.mul(new Quaternion(new Vector3(0f,0f,1f),-90f));
        curQuat = curQuat.mul(new Quaternion(new Vector3(1f,0f,0f),-90f));
        curQuat = new Quaternion(curQuat.x,curQuat.z,-curQuat.y,curQuat.w);
        ...
        //Log.d("WJF","reset quat " + curQuat.toString() + " radius " + mRotateRads);

        //MVP
        //Quaternion curQuat1 = new Quaternion(-curQuat.x, -curQuat.y,-curQuat.z, curQuat.w);
